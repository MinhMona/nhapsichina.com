<%@ Page Title="Xuất kho China" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="TQ-OutStock.aspx.cs" Inherits="NHST.manager.TQ_OutStock" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Xuất kho China</h4>
                </div>
            </div>
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    <div class="filter">
                        ...
                        <a href="javascript:;" style="margin-top:20px; background-color: blue" onclick="UpdateAll()" class="btn">Cập nhật hết tất cả kiện</a>
    ...
    <script type="text/javascript">
        ...
        function getCode(obj) {
            ...
            if (isEmpty(bc)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/manager/TQ-OutStock.aspx/GetListPackage",
                    data: "{barcode:'" + bc + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                                ...
                                                if (isExist == false) {
                                                    ...
                                                    if (check == false) {
                                                        ...
                                                        html += "<div class=\"tb-block\">";
                                                        html += "<p class=\"black-text\">ĐB 1</p>";
                                                        if (data.PDB1 == "Có") {
                                                        ...
                                                        html += "<div class=\"tb-block\">";
                                                        html += "<p class=\"black-text\">ĐB 2</p>";
                                                        if (data.PDB2 == "Có") {
                                                            html += "<p><i class=\"material-icons green-text\">check_circle</i></p>";
                                                        }
                                                        else {
                                                        ...
                                                        if (status == 5) {
                                                            html += "  <option value=\"5\" selected>Đang về kho đích</option>";
                                                        }  
                                                        html += "</select>";
                                                        html += "</div>";
                                                        html += "</td>";
        ...
        function updateWeightNew(barcode, obj, packageID) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/TQ-OutStock.aspx/UpdateQuantityNew",               
