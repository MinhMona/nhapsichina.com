        ...
        <div class="row">
            ...
            <div class="detail-fixed  col s12 m12 l6 xl6 section">
                <div class="rp-detail card-panel row">
                    <div class="col s12">
                        <div class="page-title">
                            <h5>ID#<asp:Label runat="server" ID="lbMVD"></asp:Label></h5>
                    ...
                    <div class="col s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <asp:TextBox runat="server" ID="txtEditOrderTransaction" type="text" placeholder="" class="validate" Enabled="false"></asp:TextBox>
                                <label class="active" for="mvc_detail-mvc">Mã vận đơn</label>
                            </div>
                            <div class="input-field col s12 m12">
                                <asp:TextBox runat="server" ID="txtEditWeight" TextMode="Number" class="validate" placeholder="" Enabled="false"></asp:TextBox>
                                <label class="active" for="mvc_detail-tl">Trọng lượng (kg)</label>
                            </div>
                             <div class="input-field col s12 m12">
                                <asp:TextBox runat="server" ID="txtMainOrderID" value="0" data-type="number"></asp:TextBox>
                                <label class="active" for="mvc_detail-tl">Mã đơn hàng (ID đơn hàng)</label>
                            </div>
