                                        ...
                                        for (var i = 0; i < listSmallpackage.length; i++) {
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                                ...
                                                if (check == false) {
                                                    ...
                                                    html += "<tr><td rowspan=\"100\" class=\"grey lighten-2\"><a href=\"/manager/OrderDetail.aspx?id=" + data.MainorderID + "\" target=\"_blank\">" + data.MainorderID + "</a></td></tr>";
                                                    if (data.Status == 0) {
