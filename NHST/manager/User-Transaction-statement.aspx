<%@ Page Title="Sao kê khách hàng" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="User-Transaction-statement.aspx.cs" Inherits="NHST.manager.User_Transaction_statement" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Sao kê khách hàng</h4>
                    ...
                    <div class="filter-wrap">
                        <div class="row mt-2 pt-2">
                            ...
                            <div class="col s12 right-align">
                                <asp:Button runat="server" class="btn" OnClick="btnSearch_Click" Text="Lọc kết quả"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
