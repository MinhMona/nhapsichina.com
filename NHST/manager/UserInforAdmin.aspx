<%@ Page Language="C#" Title="Thông tin tài khoản Admin" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="UserInforAdmin.aspx.cs" Inherits="NHST.manager.UserInforAdmin" %>
                ...
                <div class="rp-detail card-panel row">
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <asp:Panel ID="pnSDT" runat="server">
                                <div class="input-field col s12">
                        ...
                        <asp:Panel ID="pnAdmin" runat="server" Visible="true">
                            <div class="row border-bottom-1">
                                <div class="col s12">
                                    <h5>Cấu hình phí riêng</h5>
                                </div>
                                <asp:Panel ID="pnMana" runat="server">
                                    <div class="input-field col s12 m6">
                                        <asp:TextBox placeholder="" runat="server" ID="rCurrency" TextMode="Number"></asp:TextBox>
                                        <label for="rp_email">Tỉ giá riêng (Tệ)</label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                    ...
                                    <div class="input-field col s12 m6">
                                        ...
                                        <label for="rp_phone">Phí cân nặng riêng (VND/Kg)</label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                ...
                                <div class="input-field col s12 m6" style="display: none">
                                    <asp:DropDownList ID="ddlCSKH" runat="server" AppendDataBoundItems="true" DataValueField="ID" DataTextField="Username">
                                    </asp:DropDownList>
                                    <label>Nhân viên chăm sóc khách hàng</label>
                                </div>
