<%@ Page Title="Danh sách khách hàng saler"  MasterPageFile="~/manager/adminMasterNew.Master" Language="C#" AutoEventWireup="true" CodeBehind="saler-userlist-.aspx.cs" Inherits="NHST.manager.saler_userlist_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function AddSaler(id) {
            var r = confirm("Bạn muốn trả khách hàng này?");
            if (r == true) {
