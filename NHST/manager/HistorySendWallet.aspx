...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="page-title">
                <div class="card-panel">
                    ...
                    <div class="right-action">
                        <asp:Button ID="btnExcel" runat="server" CssClass="btn btn-success" Text="Xuất Excel" OnClick="btnExcel_Click" />
                        ...
                        <asp:Panel ID="pnadminmanager" runat="server" Visible="false">
                            <div class="input-field col s12 l4">
                                <p style="font-size: 16px; font-weight: bold;">
                                    Tổng tiền: <span style="color: #F64302;">
                            ...
                            <div class="input-field col s12 l4">
                                <p style="font-size: 16px; font-weight: bold;">
                                    Tổng tiền đã duyệt: <span style="color: #F64302;">
                                        <asp:Literal runat="server" ID="ltrMoneyAppro"></asp:Literal>
                                        đ</span>
                                </p>
                            </div>
                            <div class="input-field col s12 l4">
                                <p style="font-size: 16px; font-weight: bold;">
                                    Tổng tiền chờ duyệt: <span style="color: #F64302;">
                                        <asp:Literal runat="server" ID="ltrMoney"></asp:Literal>
                                        đ</span>
                                </p>
                            </div>
                        </asp:Panel>
                        ...
                        <div class="checkout col s12 m6">
                            <p class="black-text">
                                <span class="lbl">Tổng tiền vay chưa thanh toán:</span> <span
                                    ...
                                    <asp:Literal runat="server" ID="ltrTotalAmount"></asp:Literal></span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="rp-detail card-panel row">
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <asp:Panel runat="server" ID="bank">

                                <div class="input-field col s12">
                                    <asp:DropDownList ID="ddlBank" runat="server" DataTextField="BankInfo" CssClass="icons" DataValueField="ID">
                                    </asp:DropDownList>
    ...
    <script type="text/javascript">
        ...
        function updateNote(obj, ID) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/HistorySendWallet.aspx/UpdateStaffNote",
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=ddlBank.ClientID%>').val(data.BankId);
