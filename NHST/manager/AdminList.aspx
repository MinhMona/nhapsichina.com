<%@ Page Language="C#" Title="Danh sách Admin" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="AdminList.aspx.cs" Inherits="NHST.manager.AdminList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Danh sách Admin</h4>
                    <div class="right-action">
                        <a href="#addStaff" class="btn modal-trigger waves-effect">Thêm Admin</a>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6 m4 l2" style="display: none">
                                <asp:DropDownList runat="server" ID="ddlSearchRole">
                                    ...
                                    <asp:ListItem Value="9" Text="CSKH"></asp:ListItem>
                                </asp:DropDownList>
    ...
    <div id="addStaff" class="modal modal-fixed-footer">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">Thêm Admin</h4>
        </div>
        <div class="modal-bd">
            <div class="row">
