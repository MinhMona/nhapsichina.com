                        ...
                        <div class="row mt-2 pt-2">
                            <div class="input-field col s12 l2">
                                <asp:ListBox runat="server" ID="select_by">
                                    ...
                                    <asp:ListItem Value="3">Ngày nhập kho VN</asp:ListItem>
                                    <asp:ListItem Value="2">ID mã vận đơn</asp:ListItem>
                                </asp:ListBox>
                            ...
                            <div class="input-field col s12 l3">
                                <asp:DropDownList runat="server" ID="ddlWare">
                                    <asp:ListItem Value="0" Text="Tất cả"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Kho Hà Nội"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Kho Hồ Chí Minh"></asp:ListItem>
                                </asp:DropDownList>
                                <label for="status">Kho đích</label>
                            </div>
                            ...
                            <div class="input-field col s12 l3">
                                <label>
                                    <asp:TextBox Enabled="true" ID="cbMaVanDon" unchecked runat="server" type="checkbox" /><span id="lbCheckBox">Kiện về chưa có cân, đang có vấn đề</span></label>
                        ...
                        <table class="table  highlight bordered   mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width: 100px;">Kho đích</th>
                                    ...
                                    <th style="min-width: 100px;">STT Excel</th>
                                    <th style="min-width: 100px;">Ngày Excel</th>
                                    <th style="min-width: 120px;">Ngày về kho VN</th>
