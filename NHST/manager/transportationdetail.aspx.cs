                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        ...
                                        if (acg != null)
                                        {
                                            try
                                            {
                                                PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", acg.Email,
                                                    "Thông báo tại NHAPSICHINA.COM.", "Đơn hàng vận chuyển hộ " + t.ID + " đã được duyệt.", "");
                                            }
                                            catch { }
                                        }
