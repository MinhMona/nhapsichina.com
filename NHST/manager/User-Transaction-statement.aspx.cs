...
{
    public partial class User_Transaction_statement : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            var total = HistoryPayWalletController.GetTotal_DK_statement(fd, td);
            var la = HistoryPayWalletController.GetBySQL_DK_statement(fd, td, 20, page);
            pagingall(la, total);
        }
        #region grid event
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (fd == "" && td == "")
            {
                Response.Redirect("User-Transaction-statement.aspx");
            }
            else
            {
                Response.Redirect("User-Transaction-statement.aspx?fd=" + fd + "&td=" + td);
            }
        }
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            var la = HistoryPayWalletController.GetBySQL_DK_statement_excel(fd, td);
            ...
            string strFile = "UserTransactionStatementReport.xls";
