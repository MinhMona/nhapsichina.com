<%@ Page Title="Danh sách khách hàng hệ thống" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="sale-userlist.aspx.cs" Inherits="NHST.manager.sale_userlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdfIDuser" runat="server" />
    <asp:Button runat="server" ID="btnSearch" Text="Tìm" CssClass="btn primary-btn" OnClick="btnSearch_Click" UseSubmitBehavior="false" />
    <asp:Button runat="server" ID="btnAddSaler" Text="add" CssClass="btn primary-btn" OnClick="btnAddSaler_Click" UseSubmitBehavior="false" />
    <script>
        function myFunction() {
        ...
        function AddSaler(id) {
            var r = confirm("Bạn muốn thêm khách này vào danh sách khách của mình?");
            if (r == true) {
                $("#<%= hdfIDuser.ClientID%>").val(id);
                $("#<%= btnAddSaler.ClientID%>").click();
            }
        }
    </script>
</asp:Content>
