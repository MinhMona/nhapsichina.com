                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l4">
                                                <asp:DropDownList ID="ddlFilter" runat="server" CssClass="form-control">
                                                    ...
                                                    <asp:ListItem Value="3" Text="Số dư giảm dần"></asp:ListItem>
                                                    <asp:ListItem Value="4" Text="Số dư tăng dần"></asp:ListItem>
                                                </asp:DropDownList>
                            ...
                            <div class="row section">
                                <div class="col s12 m6">
                                    <div class="chart-wrap">
                                        <h5>Tổng số dư: <span id="totalsd">
                                            <asp:Literal runat="server" ID="lbTotalWallet"></asp:Literal>
                                            VNĐ</span></h5>
