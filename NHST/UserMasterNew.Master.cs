        ...
        public void LoadNotification()
        {
            ...
            if (acc != null)
            {
                ...
                if (config != null)
                {
                    ...
                    ltrHeaderLeft.Text += "<li style=\"margin-right: 10px;\" class=\"hide-on-med-and-down\">Số dư: </span>" + string.Format("{0:N0}", acc.Wallet) + " vnđ | </li>";
                    ...
                    var noti = NotificationsController.GetAllUID(acc.ID);
                    if (acc.RoleID != 1)
                    {
                    ...
                    {
                        ltrHeaderLeft.Text += "<div class=\"status__footer\"><a href=\"/dang-xuat-staff\" class=\"ft-btn\">ĐĂNG XUẤT</a></div></div></div>";
