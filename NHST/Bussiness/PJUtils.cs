...
namespace NHST.Bussiness
{
    public class PJUtils
    {
        ...
        public static string ReturnStatusTruyVan(int status)
        {
            if (status == 1)
            {
            ...
            {
                return "<span class='badge black darken-2 white-text border-radius-2'>Hủy</span>";
            }
            else
            {
                return "<span class='badge yellow darken-2 white-text border-radius-2'>Không xác định</span>";
            }
        }
        ...
        public static string ShowStatusPayHistory(int status)
        {
            if (status == 2)
                ...
                return "<span class=\"bg-yellow\">Đặt cọc thêm</span>";
            else if (status == 12)
        ...
        public static string IntToRequestAdminNew(int i)
        {
            if (i == 0)
                ...
                return "<span class=\"badge black darken-2 white-text border-radius-2\">Đơn hàng hủy</span>";
            else if (i == 2)
                return "<span class=\"badge orange darken-2 white-text border-radius-2\">Đơn đã cọc</span>";
            else if (i == 3)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đơn người bán giao</span>";
            else if (i == 4)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đơn chờ mua hàng</span>";
            else if (i == 5)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đơn đã mua hàng</span>";
            else if (i == 6)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Kho Trung Quốc nhận hàng</span>";
            else if (i == 7)
                return "<span class=\"badge orange darken-2 white-text border-radius-2\">Trên đường về Việt Nam</span>";
            else if (i == 8)
                return "<span class=\"badge yellow darken-2 white-text border-radius-2\">Trong kho Hà Nội</span>";
            else if (i == 9)
                ...
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Đang giao hàng</span>";
            else if (i == 12)
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Đơn khiếu nại</span>";
            else
                return "";
        ...
        public static string IntToStringStatusSmallPackageNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đang về kho đích</span>";
            else if (status == 3)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã về kho đích</span>";
            else if (status == 4)
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Đã thanh toán</span>";
        ...
        public static string IntToStringStatusSmallPackageTextNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"blue-text\">Đang giao cho khách</span>";
        }
        ...
        public static string IntToStringStatusSmallPackageWithBGNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge orange darken-2 white-text border-radius-2\">Đã thanh toán</span>";
            else if (status == 5)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đang về kho đích</span>";
            else
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Đang giao cho khách</span>";
        }
        ...
        {
            if (i == 0)
                return "<span class=\"badge red darken-2 left m-0\">Đơn mới</span>";
            else if (i == 1)
                return "<span class=\"badge black darken-2 left m-0\">Đơn hàng hủy</span>";
            else if (i == 2)
                return "<span class=\"badge bronze darken-2 left m-0\">Đơn đã cọc</span>";
            else if (i == 3)
                return "<span class=\"badge green darken-2 left m-0\">Đơn người bán giao</span>";
            else if (i == 4)
                return "<span class=\"badge green darken-2 left m-0\">Đơn chờ mua hàng</span>";
            else if (i == 5)
                return "<span class=\"badge green darken-2 left m-0\">Đơn đã mua hàng</span>";
            else if (i == 6)
                return "<span class=\"badge green darken-2 left m-0\">Kho Trung Quốc nhận hàng</span>";
            else if (i == 7)
                return "<span class=\"badge green darken-2 left m-0\">Trên đường về Việt Nam</span>";
            else if (i == 8)
                return "<span class=\"badge green darken-2 left m-0\">Trong kho Hà Nội</span>";
            else if (i == 9)
                return "<span class=\"badge blue darken-2 left m-0\">Đã thanh toán</span>";
            else if (i == 10)
                return "<span class=\"badge blue darken-2 left m-0\">Đã hoàn thành</span>";
            else if (i == 11)
                return "<span class=\"badge blue darken-2 left m-0\">Đang giao hàng</span>";
            else if (i == 12)
                return "<span class=\"badge red darken-2 left m-0\">Đơn khiếu nại</span>";
            else
                return "";
        }
        ...
        public static string ShowStatusPayHistoryUserNew(int status)
        {
            if (status == 2)
                ...
                return "<span class=\"badge orange darken-2 white-text border-radius-2\">Đặt cọc thêm</span>";
            else if (status == 12)
        ...
        public static string ReturnStatusCompalint(int Status)
        {
            if (Status == 0)
                return "<span class=\"badge black darken-2 white-text border-radius-2\">Đã hủy</span>";
            else if(Status == 1)
                ...
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Hoàn thành</span>";
            else
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Gửi Admin duyệt</span>";
        }

        public static string ReturnAdminStatusCompalint(int Status)
        {
            if (Status == 1)
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Chưa xử lý</span>";
            else
        ...
        {
            if (Status == 1)
                return "<span>Khiếu nại chiết khấu cân nặng</span>";
            else if (Status == 2)
                return "<span>Khiếu nại hàng bị vỡ, ướt, bẩn</span>";
            else if (Status == 3)
                return "<span>Khiếu nại chất lượng dịch vụ</span>";
            else if (Status == 3)
                return "<span>Khiếu nại hàng thiếu, nhầm size, nhầm hàng</span>";
            else if (Status == 4)
                return "<span>Khiếu nại hàng về chậm</span>";
            else
                return "<span>Không xác định</span>";
        }

        public static string ReturnStatusSession(int Status)
        {
            if (Status == 1)
        ...
        public static string IntToStringStatusSmallPackageWithBG45(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge border-radius-2 darken-2 green white-text\">Đang về kho đích</span>";
            else if (status == 3)
        ...
        public static void PushNotiDesktop(int UID, string title, string link)// đẩy thông báo xuống desktop trình duyệt
        {
            ...
            if (ltoken != null)
            {
                ...
                n.title = "ptite1688.com";
                n.message = title;
                n.icon = "https://ptite1688.com/Uploads/NewsIMG/2-10-2020-21420-PM.png";
                n.link = link;
