   ...
   /* width: 100%;
                                ...
                                <div class="col s12 order-info">
                                    ...
                                    <div class="order-notice">
                                        <div class="notice-wrap grey lighten-4">
                                            <p>
                                                Sản phẩm trong giỏ sẽ tự động xóa trong vòng 30 ngày. Người bán trên website 1688.com thường có quy định về số lượng mua tối thiểu, bội số mỗi sản phẩm, giá trị đơn hàng tối thiểu và sẽ từ chối bán nếu không đáp ứng. Trong trường hợp đó
    ...
    <script type="text/javascript">
        ...
        function updatequantity(ID, obj, shopid) {
            var quantity = obj.parent().parent().parent().find(".quantitiofpro").val();
    ...
    <script>
        function minus_plus(id, shopid, check) {
            ...
            var te = $("#DGTe" + id + "-" + shopid).text();
            var tygia = $("#TyGia" + id + "-" + shopid).text();
            var vnd = $("#DGVND" + id + "-" + shopid).text();
            var vndcu = $("#THVND" + id + "-" + shopid).text();
            var tongvnd = $("#Tienhang" + shopid).text();
            $.ajax({
                type: "POST",
                url: "/Cart.aspx/UpdateQuantityTemps",
                data: "{ID:'" + id + "',MoneyTQ:'" + te + "',MoneyVN:'" + vnd + "',Money:'" + tongvnd + "',SL:'" + sl + "',check:'" + vndcu + "',TyGia:'" + tygia + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    $("#THTe" + id + "-" + shopid).text(msg.d.te);
                    debugger
