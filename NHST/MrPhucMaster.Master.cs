...
namespace NHST
{
    public partial class MrPhucMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadMenuMobile()
        {
            ...
            if (categories != null)
            {
                html += "<ul class=\"nav-mobile-menu-item\">";
                foreach (var c in categories)
                {
                    var categories2 = MenuController.GetByLevel(c.ID);
                    if (categories2 != null)
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTopLeft.Text += "<p class=\"text\">¥ Tỉ giá: 1 Tệ = <span>" + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + " Đồng</span></p>";
                ltrTopLeft.Text += "<p class=\"text\">Hotline: <span><a href=\"tel:" + hotline + "\">" + hotline + "</a></span> (GIỜ LÀM VIỆC: <span><a href=\"mailto:" + timework + "\">" + timework + ")</a></span></li>";

                ltrLogo.Text = "<a href=\"/\"><img class=\"nav-menu-img\" src=\"" + confi.LogoIMG + "\" alt=\"\"></a>";
                ...
                ltrHotLine.Text += "<p>Hotline: <span><a href=\"tel:" + hotline + "\">" + hotline + "</a></span></p>";
            ...
            else
            {
                ...
                ltrLogin.Text += "       <a href=\"/quen-mat-khau\" class=\"btn btn-login\"><i class=\"fa fa-unlock-alt\" aria-hidden=\"true\"></i> Quên mật khẩu</a>";
                ltrLogin.Text += "       <a href=\"/dang-ky\" class=\"btn btn-login\"><i class=\"fa fa-sign-out-alt\" aria-hidden=\"true\"></i>Đăng ký</a>";
                ltrLogin.Text += "       <a href=\"/dang-nhap\" class=\"btn btn-login\"><i class=\"fa fa-user-alt\" aria-hidden=\"true\"></i>Đăng nhập</a>";
                ltrLogin.Text += "</ul>";
            }
        }
    }
