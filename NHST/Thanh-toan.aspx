...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                        ...
                        <div class=" mt-3 ">
                            ...
                            <div class="row pb-5">
                                <div class="col s12 m12 l7">
                                    ...
                                    <div class="address-wrapper card-panel" style="display:none;">
                                        <div class="title-block">
        ...
        $("#finishorder").click(function () {
            ...
            if (check) {
                ...
                $(".shop-item-wrap").each(function () {
                    ...
                    var percentdeposit = obj.find(".percentselect").val();

                    if (warehouseID == 0 || warehousefromID == 0 || shippingtype == 0) {
                        warehouse = false;
                    }                     

                    html += id + ":" + warehouseID + "-" + shippingtype + "-" + warehousefromID + "-" + percentdeposit + "|";
                });
                if (warehouse == false) {
                    alert('Bạn chưa chọn phương thức vận chuyển');
                }                
                else {
    ...
    <script>
        function Shipping(index, count) {
            var type = document.getElementById("TypeShip_" + index).value;
            var counts = "";
            for (var i = 0; i < count; i++) {
                counts += document.getElementById("TypeShip_" + i).value + ",";
            }
            $.ajax({
                type: "POST",
                url: "/Thanh-toan.aspx/ShippingEdit",
                data: "{index:'" + index + "', sCount:'" + counts + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var data = JSON.parse(msg.d);
                    if (data != null) {
                        document.getElementById("ShipFee_" + index).innerHTML = data.shipmoney;
