...
namespace NHST.Controllers
{
    public class ConfigurationController
    {
        ...
        public static string UpdateVer2(int ID, string Websitename, string EmailSupport, string EmailContact, string Hotline, string Address, string Facebook, string Twitter, string GooglePlus, string Instagram,
          ...
          string FeeDongGoKgDau,string FeeDongGoKgSau,string FeeDacBiet1,string FeeDacBiet2)
        {
            using (var dbe = new NHSTEntities())
            {
                dbe.Configuration.ValidateOnSaveEnabled = false;
                ...
                if (conf != null)
                {
                    conf.FeeDongGoKgDau = FeeDongGoKgDau;
                    conf.FeeDongGoKgSau = FeeDongGoKgSau;
                    conf.FeeDacBiet1 = FeeDacBiet1;
                    conf.FeeDacBiet2 = FeeDacBiet2;
