...
namespace NHST.Controllers
{
    public class ServiceController
    {
        ...
        public static tbl_Service Update(int ID, string ServiceName, string ServiceContent, string ServiceLink, string ServiceIMG, string ServiceIcon, bool IsHidden, int Position, string Created)
        {
            using (var db = new NHSTEntities())
            {
