<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="NHST.manager.AdminLogin" %>
                        ...
                        <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <h5 class="align-center">Đăng nhập dành cho quản trị</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <a style="background: #356237 !important;" class="btn waves-effect waves-light border-round bg-dark-gradient col s12" onclick="login()">Đăng nhập</a>
                                </div>
                            </div>
                            <div class="row">
