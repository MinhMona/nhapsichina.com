<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkingSession.aspx.cs" MasterPageFile="~/manager/adminMasterNew.Master" Inherits="NHST.manager.WorkingSession" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Phiên làm việc tại kho Việt Nam</h4>
                </div>
            </div>
                    ...
                    <div class="filter">
                        <div class="select-bao">
                            <div class="input-field inline">
                                <asp:DropDownList runat="server" ID="ddlSession" AppendDataBoundItems="true"
                                    DataValueField="ID" DataTextField="NameSession">
                                </asp:DropDownList>
                            </div>
                            <a href="#addBadge" class="btn modal-trigger waves-effect" style="background-color: orangered">Tạo mới Phiên làm việc</a>
                        </div>
                        <div class="search-name input-field no-margin">
                            <input placeholder="Nhập mã vận đơn" id="barcode-input" type="text" class="barcode">
    ...
    <div id="addBadge" class="modal modal-big add-package">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">Thêm Phiên làm việc mới</h4>
        </div>
        <div class="modal-bd">
            <div class="row">

                <div class="input-field col s12 m12">
                    <asp:TextBox runat="server" ID="txtPackageCode" CssClass="validate"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function btnCompletedSession() {
            var c = confirm('Bạn muốn kết thúc phiên làm việc này.');
            if (c == true) {
        ...
        function AddBigPackage() {
            ...
            var packageNote = $("#<%=txtPackageNote.ClientID%>").val();
            if (!isEmpty(packageCode)) {
                $.ajax({
                    type: "POST",
                    url: "/manager/WorkingSession.aspx/AddBigPackage",
                    data: "{PackageCode:'" + packageCode + "', PackageNote:'" + packageNote + "'}",
                    ...
                    success: function (msg) {
                        ...
                        if (data != null) {
                            if (data != "existCode") {
                                ...
                                alert('Mã phiên làm việc đã tồn tại.');
                            }
                        }
                        else {
                ...
                alert('Không được để trống mã phiên làm việc.');
            }
        }
        ...
        $(document).ready(function () {
            ...
            $('#barcode-input').keydown(function (e) {
                if (e.key === 'Enter') {
                    ...
                    if (session == 0)
                        alert('Bạn chưa chọn phiên làm việc.');
                    else {
                        getCode($(this));
                        e.preventDefault();
                        return false;
        ...
        function getCode(obj) {
            ...
            if (isEmpty(bc)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/manager/WorkingSession.aspx/GetListPackage",
                    data: "{barcode:'" + bc + "',session:'" + session + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        if (msg.d != "none") {
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                                ...
                                                if (isExist == false) {
                                                    ...
                                                    if (check == false) {
                                                        ...
                                                        html += "<th style=\"min-width: 50px;\">Mã đơn</th>";
                                                        html += "<th style=\"min-width: 50px;\">Loại đơn</th>";
                                                        html += "<th style=\"min-width: 100px;\">Dịch vụ</th>";
                                                        ...
                                                        html += "<th style=\"width: 100px;\">Ghi chú kiểm hàng</th>";
                                                        //html += "<th style=\"min-width: 50px;\">Hình ảnh</th>";
                                                        html += "<th>Thời gian <br />shop phát hàng</th>";
                                                        html += "<th>Kho nhận <br />phương thức</th>";
                                                        ...
                                                        html += "<div class=\"tb-block\" style=\"padding-left: 10px; padding-right: 10px;\">";
                                                        html += "<p class=\"black-text\">ĐB1</p>";
                                                        if (data.PDB1 == "Có") {
                                                        ...
                                                        html += "</td>";
                                                        html += "<td><span>" + data.DateShop + "</span></td>";

                                                        html += "<td>";
                                                        html += "<span style=\"display:grid;\">" + data.NameReceivePlace + "</span>";
                                                        html += "<span>" + data.NameShippingType + "</span>";
                                                        html += "</td>";
                            ...
                            alert('Không tìm thấy kiện hoặc kiện đã tồn tại trong phiên khác.');
                            obj.val("");
                        }
                    },
        ...
        function updateWeightNew(barcode, obj, packageID) {
            ...
            var status = 3; /*obj.parent().parent().parent().find(".package-status-select").val();*/
            ...
            $.ajax({
                type: "POST",
                url: "/manager/WorkingSession.aspx/UpdateQuantityNew",
                data: "{barcode:'" + barcode + "',quantity:'" + quantity + "',status:'" + status
                    ...
                    + "',loaisanpham:'" + producttype + "', sessionID:'" + session + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var data = msg.d;
