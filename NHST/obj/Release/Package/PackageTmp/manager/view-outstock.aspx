                                            ...
                                            <div class="input-field col s12 m4">
                                                <div class="action-wrap">
                                                    <asp:Panel ID="pnButton" runat="server">
                                                        <asp:Button ID="btncreateuser_inbill" runat="server" Text="In phiếu xuất kho" CssClass="btn"
                                                            OnClick="btncreateuser_inbill_Click" UseSubmitBehavior="false" />
                                                    </asp:Panel>
                                                </div>
                                            </div>
                                            <div class="input-field col s12">
                                                <div class="action-wrap checkout">
                                                    <asp:Button ID="btncreateuser" runat="server" Text="Thanh toán bằng tiền mặt" Style="margin-right: 10px; display: none;" CssClass="btn" OnClick="btncreateuser_Click" UseSubmitBehavior="false" />
                                                    <asp:Button ID="btnPayByWallet" runat="server" Text="Thanh toán bằng ví" Style="margin-right: 5px; display: none;" CssClass="btn" OnClick="btnPayByWallet_Click" UseSubmitBehavior="false" />
