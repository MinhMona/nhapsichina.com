<%@ Page Language="C#" Title="Import Excel kho Trung Quốc" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="import-smallchina.aspx.cs" Inherits="NHST.manager.import_smallchina" %>
            ...
            <div class="col s12 page-title">
                <div class="card-panel">
                    <div class="title-flex">
                        <h4 class="title no-margin">Import Mã Vận Đơn Xuất Kho Trung Quốc</h4>
                    </div>
                </div>
            </div>
