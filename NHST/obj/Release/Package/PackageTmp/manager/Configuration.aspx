        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH HỆ THỐNG NHAPSICHINA.COM</h4>
                            ...
                            <div id="value-sec" class="section scrollspy fee-order">
                                ...
                                <div class="child-fee">
                                    <div class="content-panel">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6">
                                                <asp:TextBox runat="server" placeholder="0" type="text" ID="txtKgDau" value=""></asp:TextBox>
                                                <label>Đóng gỗ kg đầu</label>
                                            </div>

                                            <div class="input-field col s12 m6">
                                                <asp:TextBox runat="server" placeholder="0" type="text" ID="txtKgSau" value=""></asp:TextBox>
                                                <label>Đóng gỗ kg sau</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12 m6">
                                                <asp:TextBox runat="server" placeholder="0" type="text" ID="txtDacbiet1" value=""></asp:TextBox>
                                                <label>Phí đặc biệt 1</label>
                                            </div>

                                            <div class="input-field col s12 m6">
                                                <asp:TextBox runat="server" placeholder="0" type="text" ID="txtDacbiet2" value=""></asp:TextBox>
                                                <label>Phí đặc biệt 2</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
