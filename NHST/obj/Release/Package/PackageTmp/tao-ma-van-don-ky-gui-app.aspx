...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                                    ...
                                    <table class="tb-kienhang tr-removeable">
                                        ...
                                        <tbody class="product-list">
                                            <tr class="product-item">
                                                ...
                                                <td>
                                                    <input type="text" class="gray-bg fcontrol note-ip product-note"></td>
    ...
    <script type="text/javascript">
        ...
        function addProduct() {
            ...
            html += " <td><input type=\"text\" class=\"gray bg fcontrol note-ip product-note\" placeholder=\"Ghi chú\"/></td>";
        ...
        function CreateOrder() {            
            ...
            $(".product-item").each(function () {
                ...
                var productnote_obj = item.find(".product-note");
                var productnote = item.find(".product-note").val();
