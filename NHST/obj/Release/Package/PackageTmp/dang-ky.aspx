...
<body class="horizontal-layout page-header-light horizontal-menu 1-column login-bg  blank-page blank-page" data-open="click" data-menu="horizontal-menu" data-col="1-column">
    <form id="form1" runat="server" class="login-form" enctype="multipart/form-data">
                        ...
                        <div class="col s12 m8 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                            ...
                            <div class="row">
                                <div class="input-field col s12 align-center">
                                    <span class="img logo-login">
                                        <a href="/">
                                            <img src="/App_Themes/nhapsichina/images/logo.png" alt="logo"></a></span>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <span class="helper-text">
                                        <asp:RegularExpressionValidator
                                            ...
                                            runat="server"
                                            ErrorMessage="Username ít nhất 6 ký tự. Không số và viết liền không dấu" Display="Dynamic"
                                            ControlToValidate="txtUsername" ForeColor="Red"
                                            ValidationExpression="[^ ,   ][a-zA-Z]{5,}" ValidationGroup="Group" />
                                    ...
                                    <%--<span class="helper-text">
                                        <asp:requiredfieldvalidator runat="server" id="requiredfieldvalidator6" forecolor="red" ControlToValidate="txtUsername" 
                                            Display="Dynamic" validationexpression="[0-9a-zA-Z]{6,}" errormessage="viết liền không dấu !!!" validationgroup="group"/>
                                    </span>--%>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <asp:TextBox runat="server" placeholder="Số điện thoại" ID="txtPhone" MaxLength="11" type="text"></asp:TextBox>
                                    <span class="helper-text">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <a class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12" href="javascript:;" onclick="register()">Đăng ký</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
        ...
        <script>
            function register() {
                var r = confirm("Đăng ký tài khoản");
                if (r == true) {                   
