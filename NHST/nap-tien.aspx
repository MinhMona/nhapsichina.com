                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="donate-guide">
                                                        ...
                                                        <strong>thanh toán</strong> một khoản tiền <strong>đặt
                                                            cọc trước cho NHAPSICHINA.COM </strong>để chúng tôi thực hiện
                                                        ...
                                                        <p class="pl-3">
                                                            ...
                                                            website đặt hàng Trung Quốc, số tiền này <strong>NHAPSICHINA.COM thu hộ cho </strong>
                                                            nhà cung cấp.
                                                        </p>
                                                        <p class="pl-3">
                                                            + <strong>Phí dịch vụ</strong>: là phí khách hàng
                                                        trả cho <strong>NHAPSICHINA.COM </strong>để tiến hành thu mua theo đơn hàng đã đặt.
                                                        </p>
                                                        ...
                                                        <p class="pl-3 fix" style="text-decoration: underline;"><strong>VĂN PHÒNG KINH DOANH VÀ KHO MIỀN BẮC</strong></p>
                                                        <p class="pl-3 fix"><strong>1. Đường Duy Tân - Dịch Vọng Hậu - Cầu Giấy - Hà Nội</strong></p>
                                                        <p class="pl-3 fix"><strong>2. Đường Hồ Tùng Mậu - Nam Từ Liêm - Hà Nội</strong></p>
                                                        <p class="pl-3 fix"><strong>Hotline: 0965.27.6680</strong></p>
                                                        <p class="pl-3 fix"><strong>Kho:     0906.19.9193</strong></p>

                                                        <p class="pl-3 fix" style="text-decoration: underline;"><strong>VĂN PHÒNG KINH DOANH VÀ KHO MIỀN NAM</strong></p>
                                                        <p class="pl-3 fix"><strong>Địa chỉ : Phường 4 - Quận Tân Bình - TP Hồ Chí Minh. </strong></p>
                                                        <p class="pl-3 fix"><strong>Hotline: 038.717.1688</strong></p>
                                                        ...
                                                        <p class="pl-3" style="font-size: 16px;">+ <strong>NAP tentaikhoan sodienthoai</strong></p>
                                                    ...
                                                    <div class="card-panel donate-information mt-3" style="display:none">
