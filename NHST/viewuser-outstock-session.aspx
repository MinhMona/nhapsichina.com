<%@ Page Title="Chi tiết phiếu in" MasterPageFile="~/UserMasterNew.Master" Language="C#" AutoEventWireup="true" CodeBehind="viewuser-outstock-session.aspx.cs" Inherits="NHST.viewuser_outstock_session" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="main" class="main-full">
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel" style="text-align: center;width: 1170px;margin: auto;margin-top: 20px;margin-bottom: 10px;">
                    <h4 class="title no-margin" style="display: inline-block;">Chi tiết phiếu in<asp:Literal runat="server" ID="ltrIDS"></asp:Literal></h4>
                    <div class="right-action">
                    </div>
                </div>
            </div>
            <div class="list-staff col s12 m12 l12 section" id="customer-export">
                <div class="all">
                                    ...
                                    <div class="col s12">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12 m4" style="display:none">
                                                <asp:TextBox placeholder="" runat="server" ID="txtUsername" type="text" class="validate" value=""></asp:TextBox>
                                            ...
                                            <asp:Panel ID="pnPrice" runat="server" Visible="false">
                                                <div class="input-field col s12 m4" style="margin: 0px; display:none;">
                                                    <div class="order-row">
                                                        <div class="left-fixed" style="width:50px;">
                                                            <div class="row">
                                                                <div class="input-field col s12 m2">
                                                                    <label style="top: -15px;">
                                                                        <input type="checkbox" class="filled-in chk-check-option" data-id="9" id="cbchkPrice" />
                                                                        <span></span>
                                                                    </label>
                                                                    <asp:HiddenField ID="chkPrice" runat="server" />
                                                                    <asp:HiddenField ID="chkPriceto" runat="server" />
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="input-field col s12">
                                                <div class="action-wrap checkout" style="display: flex; justify-content: space-between">
                                                    
                                                    <a href="/user-outstock-payment" class="btn ">Trở về</a>
    ...
    <script>
        $(document).ready(function () {
            ...
            var cb = $("#<%=chkPrice.ClientID %>").val();

            $('#cbchkPrice').prop("checked", (/true/i).test(cb.toLowerCase()));
        })
        ...
        function UpdateOrder() {
            if ($('.chk-check-option').prop("checked") == true)
                $("#<%=chkPriceto.ClientID %>").val(1);
            else
                $("#<%=chkPriceto.ClientID %>").val(0);
