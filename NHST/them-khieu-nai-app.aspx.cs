        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (u != null)
            {
                ...
                if (shops != null)
                {
                    ...
                    string kq = ComplainController.Insert(UID, orderid, pAmount.Value.ToString(), IMG, txtNote.Text, 1, DateTime.Now, u.Username, 0);
                    if (kq.ToInt(0) > 0)
                    {
                                        ...
                                        foreach (var admin in admins)
                                        {
                                            try
                                            {
                                                PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", admin.Email,
                                                    "Thông báo tại Hải Phát Logistisc.", "Đã có khiếu nại mới cho đơn hàng #" + orderid + ". CLick vào để xem", "");
                                            }
                                            catch { }
                                        }
                                    }
